export const translations: { [key: string]: any } = {
	...
	PAGE_CREATE_WALLET: {
		...
		PASSPHRASE_STEP: {
			...
			WARNING:
				"This is your 12 word Mnemonic. Your mnemonic serves as your password and allows you to send any funds associated with your address. If lost, this mnemonic cannot be restored by anyone, including the Blockpool team. Please store this mnemonic in a safe location and do not share it with anyone.",
			DOWNLOAD: {
