...
export const availableNetworksMock: Coins.Network[] = [
	...
	new Coins.Network(BPL.manifest.name, BPL.manifest.networks["bpl.mainnet"]),
	new Coins.Network(BPL.manifest.name, BPL.manifest.networks["bpl.testnet"]),
