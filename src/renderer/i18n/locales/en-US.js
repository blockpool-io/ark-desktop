export default {
  ...
  WALLET_DELEGATES: {
    ...
    BLOG: 'Voting Guide',
    EXPLANATION: 'Voting is an optional, but important mechanism that keeps the Blockpool network secure. The 51 delegates with the most votes from the network are responsible for verifying and forging transactions into new blocks. This page can be used to cast your vote for a delegate that you support. Learn more about voting for a delegate by clicking on the following link:',
